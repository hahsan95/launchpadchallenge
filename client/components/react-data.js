  ...
  render () {
    ...
    return (
      <Wrapper>
        <Segment>
          <h3>React</h3>
          <Progress color='blue' active  size='small' value={forks} total={100}>{forks} Forks</Progress>
          <Progress color='blue' active  size='small' value={commits} total={100}>{commits} Commits</Progress>
          <Progress color='blue' active  size='small' value={prs} total={100}>{prs} Pull Requests</Progress>
        </Segment>
        <Divider />
      </Wrapper>
    )
